                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            ...
                            <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('event.store')}}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="card-body">

                                <div class="form-group col-md-6 float-left">
                                    <label for="exampleInputPassword1">Event Name</label>
                                    <input type="text" name="event_name" value="{{ old('event_name') }}" required autocomplete="off" class="form-control" id="exampleInputPassword1" placeholder="Event Name">
                                    @error('event_name')
