...
@section('content')
    ...
    @include('layouts.admin_blade_title', [
                'title' => 'Manage Category Slider',
                'link' => route("categorySlider.create"),
                'text' => "Create Category Slider"
            ])
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($sliders as $index => $slider)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('categorySlider.update', $slider->id) }}" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('categorySlider.destroy',$slider->id)}}" method="post">
                                                                    @csrf
                                                                    @method("DELETE")
