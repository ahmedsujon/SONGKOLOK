                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            <div class="card-header">
                                <h3 class="card-title">Create Category Slider</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{route('categorySlider.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
